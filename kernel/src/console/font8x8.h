#ifndef LEDGEROS_FONT8X8_H
#define LEDGEROS_FONT8X8_H

#include <stdint.h>

// Standard 8x8 font (printable ASCII + a few symbols, 128 characters)
static const uint8_t font8x8_basic[128][8] = {
    ...
    [0x3B] = {0x00,0x18,0x18,0x00,0x18,0x18,0x08,0x10}, // ;
    ...
    [0x51] = {0x3C,0x66,0x66,0x66,0x6A,0x6C,0x3A,0x00}, // Q
    ...
    [0x5A] = {0x7E,0x0C,0x18,0x30,0x60,0xC0,0x7E,0x00}, // Z
    [0x5B] = {0x3E,0x30,0x30,0x30,0x30,0x30,0x3E,0x00}, // [
    [0x5C] = {0x80,0xC0,0x60,0x30,0x18,0x0C,0x06,0x00}, // \ (escaped)
    ...
    [0x60] = {0x18,0x18,0x30,0x00,0x00,0x00,0x00,0x00}, // `
    ...
    [0x6A] = {0x06,0x00,0x0E,0x06,0x06,0x06,0x66,0x3C}, // j
    ...
    [0x7E] = {0x00,0x00,0x76,0x3E,0x00,0x00,0x00,0x00}, // ~
    [0x7F] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // Delete (empty)
};
